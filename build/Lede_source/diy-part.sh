...
sed -i "s/OpenWrt /${lu} Compiled in $(TZ=UTC-8 date "+%Y.%m.%d") @ OpenWrt /g" $ZZZ                                # 增加个性名字281677160
...
git clone https://github.com/garypang13/luci-app-bypass package/luci-app-bypass                  #增加bypass插件
